...
# 设置主类
MAIN_CLASS="com.watoukuang.altxch.member.AltxchMemberApplication"

# 设置 JAR 文件和 lib 目录
JAR_FILE="$SCRIPT_DIR/../altxch-ucenter.jar"
...
if ps -p $PID > /dev/null; then
    echo "Altxch Ucenter Application started successfully with PID: $PID"
else
    echo "Failed to start Altxch Ucenter Application."
