...
# 设置主类
MAIN_CLASS="com.watoukuang.altxch.match.AltxchMatchApplication"

# 设置 JAR 文件和 lib 目录
JAR_FILE="$SCRIPT_DIR/../altxch-match.jar"
...
if ps -p $PID > /dev/null; then
    echo "Altxch Exchange Application started successfully with PID: $PID"
else
    echo "Failed to start Altxch Exchange Application."
