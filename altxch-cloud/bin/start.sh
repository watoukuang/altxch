...
# 设置主类
MAIN_CLASS="com.watoukuang.altxch.cloud.AltxchCloudApplication"

# 设置 JAR 文件和 lib 目录
JAR_FILE="$SCRIPT_DIR/../altxch-cloud.jar"
...
if ps -p $PID > /dev/null; then
    echo "Altxch Cloud Application started successfully with PID: $PID"
else
    echo "Failed to start Altxch Cloud Application."
